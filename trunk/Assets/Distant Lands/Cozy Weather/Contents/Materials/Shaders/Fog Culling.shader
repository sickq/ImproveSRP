...
Shader "Fog Culling"
{
	Properties
	{
		...
		[ASEBegin]_Thickness("Thickness", Float) = 500
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float temp_output_49_0 = ( break69.x > abs( ( _WorldSpaceCameraPos.x - objToWorld77.x ) ) ? 1.0 : 0.0 );
				float temp_output_55_0 = ( break69.y > abs( ( _WorldSpaceCameraPos.y - objToWorld77.y ) ) ? 1.0 : 0.0 );
				float temp_output_61_0 = ( break69.z >= abs( ( _WorldSpaceCameraPos.z - objToWorld77.z ) ) ? 1.0 : 0.0 );
				float isInsideBoundingBox63 = ( temp_output_49_0 * temp_output_55_0 * temp_output_61_0 );
				float temp_output_67_0 = ( 1.0 - isInsideBoundingBox63 );
				float4 screenPos = IN.ase_texcoord3;
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float4 fetchOpaqueVal12 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ase_grabScreenPosNorm ), 1.0 );
				float temp_output_32_0 = length( ( WorldPosition - _WorldSpaceCameraPos ) );
				...
				float3 temp_output_91_0_g19 = WorldPosition;
				...
				float4 lerpResult71 = lerp( fetchOpaqueVal12 , ( ( temp_output_10_0_g23 * CZY_SunFilterColor ) + temp_output_10_0_g22 ) , ( finalAlpha141_g19 * saturate( ( ( 1.0 - saturate( ( ( ( direction90_g19.y * 0.1 ) * ( 1.0 / ( ( CZY_FogSmoothness * length( ase_objectScale ) ) * 10.0 ) ) ) + ( 1.0 - CZY_FogOffset ) ) ) ) * CZY_FogIntensity ) ) ));
				...
				float switchResult33 = (((ase_vface>0)?(( ( temp_output_30_0 > temp_output_32_0 ? 1.0 : 0.0 ) * temp_output_67_0 )):(( isInsideBoundingBox63 * ( temp_output_30_0 < temp_output_32_0 ? 1.0 : 0.0 ) ))));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( temp_output_67_0 == 1.0 ? lerpResult71 : fetchOpaqueVal12 ).rgb;
				float Alpha = switchResult33;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = switchResult33;
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;416,-64;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Fog Culling;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;True;2;False;;False;False;False;False;False;False;False;False;True;True;True;221;False;;221;False;;221;False;;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;True;True;True;221;False;;221;False;;221;False;;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;True;2;False;;True;7;False;;True;False;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638351485647545821;  Blend;0;0;Two Sided;0;638352314565164672;Forward Only;1;638258580317422413;Cast Shadows;0;638258581127195628;  Use Shadow Threshold;0;0;Receive Shadows;0;638258581134720830;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.SwitchByFaceNode;73;96,-240;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;75;-736,-448;Inherit;False;Stylized Fog ASE Function;1;;19;649d2917c22fd754aa7be82b00ec0d80;0;2;151;FLOAT;0;False;91;FLOAT3;0,0,0;False;2;COLOR;0;FLOAT;56
Node;AmplifyShaderEditor.SimpleSubtractOpNode;76;-896,-304;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-1135.596,-305.3645;Inherit;False;Property;_Thickness;Thickness;0;0;Create;True;0;0;0;False;0;False;500;500;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;48;-1296,-800;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;79;-160.1729,-671.4575;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=D27F85F8E4383095D4F0C1D5CE1655E22C93436A