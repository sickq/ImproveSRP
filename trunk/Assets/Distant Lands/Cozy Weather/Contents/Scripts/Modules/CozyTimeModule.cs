...
{
    [ExecuteAlways]
    public class CozyTimeModule : CozyModule, ICozyBiomeModule
    {
        ...
        public List<CozyTimeModule> biomes;
        public float weight;
        ...
        public void AddBiome()
        {
            ...
            if (parentModule == null)
                parentModule = weatherSphere.timeModule;

            weatherSphere.timeModule.biomes = FindObjectsOfType<CozyTimeModule>().Where(x => x != weatherSphere.timeModule).ToList();
        ...
        public void ComputeBiomeWeights()
        {
            ...
            foreach (CozyTimeModule biome in biomes)
            {
                if (biome != this)
                {
