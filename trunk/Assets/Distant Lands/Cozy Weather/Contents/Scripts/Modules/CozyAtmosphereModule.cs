...
namespace DistantLands.Cozy
{
    ...
    public class CozyAtmosphereModule : CozyModule, ICozyBiomeModule
    {
        ...
        /// </summary> 
        public void ChangeAtmosphere(AtmosphereProfile start, AtmosphereProfile end, float weight)
        {

            StartCoroutine(TransitionAtmosphere(end, weight));

        }

        IEnumerator TransitionAtmosphere(AtmosphereProfile end, float weight)
        {
