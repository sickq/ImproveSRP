	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 tanNormal13 = UnpackNormalScale( tex2D( _Normals, uv_Normals ), 1.0f );
				...
				float dotResult12 = dot( worldNormal13 , CZY_SunDirection );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = CZY_MoonColor.rgb;
				float Alpha = ( CZY_MoonColor.a * length( tex2D( _MainTexture, uv_MainTexture ).a ) * saturate( (dotResult12*_AlphaScale + _AlphaOffset) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( CZY_MoonColor.a * length( tex2D( _MainTexture, uv_MainTexture ).a ) * saturate( (dotResult12*_AlphaScale + _AlphaOffset) ) );
...
Node;AmplifyShaderEditor.Vector3Node;14;-1024,288;Inherit;False;Global;CZY_SunDirection;CZY_SunDirection;1;0;Create;True;0;0;0;False;0;False;0,1,0;0.9125065,0.1198834,-0.3911007;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;11;-528,-224;Inherit;False;Global;CZY_MoonColor;CZY_MoonColor;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.01246242,0.01038535,0.01993987,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=359B0A86E787E9B9206A7E05B51ADFBB16B2932C