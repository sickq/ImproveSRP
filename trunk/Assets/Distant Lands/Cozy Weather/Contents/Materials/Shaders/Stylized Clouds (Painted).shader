	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 CloudColor332 = ( temp_output_10_0_g3 * CZY_CloudFilterColor );
				...
				float4 CloudHighlightColor334 = ( temp_output_10_0_g2 * CZY_SunFilterColor );
				...
				float CloudThicknessDetails329 = ( VoroDetails313.x * saturate( ( CumulusCoverage376 - 0.8 ) ) );
				...
				half MoonlightMask790 = saturate( pow( abs( (dotResult780*0.5 + 0.5) ) , CZY_MoonFlareFalloff ) );
				...
				float4 MoonlightColor797 = ( temp_output_10_0_g4 * CZY_CloudFilterColor );
				...
				float4 ChemtrailsFinal590 = ( ChemtrailsPattern576 * saturate( (0.4 + (dotResult584 - 0.0) * (2.0 - 0.4) / (0.1 - 0.0)) ) * ( CZY_ChemtrailsMultiplier * 0.5 ) );
				...
				float4 CloudTexture839 = min( tex2D( CZY_CloudTexture, (panner855*1.0 + 0.75) ) , tex2D( CZY_CloudTexture, (rotator818*3.0 + 0.75) ) );
				...
				float4 lerpResult272 = lerp( float4( 0,0,0,0 ) , CloudHighlightColor334 , ( saturate( CumulusCoverage376 ) * CloudTextureFinal847 * CloudLight271 ));
				...
				float4 CirrusCustomLightColor512 = ( CloudColor332 * ( temp_output_10_0_g5 * CZY_CloudFilterColor ) );
				float time601 = 0.0;
				...
				float2 coords463 = (Pos159*1.0 + ( CZY_AltocumulusWindSpeed * TIme152 )) * ( 100.0 / CZY_AltocumulusScale );
				float2 id463 = 0;
				float2 uv463 = 0;
				float fade463 = 0.5;
				float voroi463 = 0;
				...
				voroi463 /= rest463;
				float AltoCumulusLightTransport447 = saturate( (-1.0 + (( AltoCumulusPlacement461 * ( 0.1 > voroi463 ? (0.5 + (voroi463 - 0.0) * (0.0 - 0.5) / (0.15 - 0.0)) : 0.0 ) * CZY_AltocumulusMultiplier ) - 0.0) * (3.0 - -1.0) / (1.0 - 0.0)) );
				...
				float4 CirrostratLightTransport641 = ( CirrostratPattern634 * saturate( (0.4 + (dotResult630 - 0.0) * (2.0 - 0.4) / (0.1 - 0.0)) ) * ( CZY_CirrostratusMultiplier * 1.0 ) );
				...
				float4 lerpResult898 = lerp( CZY_CloudTextureColor , CZY_LightColor , float4( 0.5,0.5,0.5,0 ));
...
Node;AmplifyShaderEditor.CommentaryNode;373;-203.3957,-786.2642;Inherit;False;1226.633;651.0015;Simple Density;19;314;37;42;313;63;312;60;157;148;62;234;65;66;235;68;161;41;67;156;;0.4392157,1,0.7085855,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;806;-3574.271,115.5002;Inherit;False;2654.838;1705.478;;2;821;807;Cloud Texture Block;0.345098,0.8386047,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;807;-3532.259,169.0804;Inherit;False;2197.287;953.2202;Pattern;13;839;827;826;824;823;818;816;814;812;808;855;874;875;;0.345098,0.8386047,1,1;0;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;37;466.9412,-696.6409;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;462;-162.0468,961.969;Inherit;False;2021.115;830.0204;Placement Noise;14;452;455;461;457;458;442;451;454;491;492;494;600;601;602;;0.6637449,0.4708971,0.6981132,1;0;0
...
Node;AmplifyShaderEditor.SimpleMinOpNode;69;1582.449,-520.7233;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;826;-2398.256,709.6829;Inherit;True;Property;_TextureSample2;Texture Sample 2;1;0;Create;True;0;0;0;False;0;False;-1;None;9b3476b4df9abf8479476bae1bcd8a84;True;0;False;white;Auto;False;Instance;827;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;821;-3516.336,1183.734;Inherit;False;1600.229;583.7008;Final;7;847;843;842;841;838;836;894;;0.345098,0.8386047,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;678;6186.058,-1754.588;Inherit;False;1735.998;586.5895;Final;13;715;714;695;689;701;698;700;697;694;690;685;899;900;;1,0.6554637,0.4588236,1;0;0
...
Node;AmplifyShaderEditor.VoronoiNode;601;515.2736,1436.263;Inherit;False;0;0;1;3;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;10;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.VoronoiNode;492;1069.963,1399.258;Inherit;False;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;12.27;False;2;FLOAT;10;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.CommentaryNode;407;-422.4442,-4222.23;Inherit;False;2843.676;639.4145;Final Alpha;22;883;884;885;408;411;410;644;598;871;497;713;868;869;870;867;863;866;865;862;414;740;409;;0.6196079,0.9508546,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;573;5233.789,-2343.38;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;527;1904.552,952.911;Inherit;False;939.7803;621.1177;Lighting & Clipping;8;512;510;511;524;521;509;519;921;;0.6637449,0.4708971,0.6981132,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;918;-3872,-4352;Inherit;False;Filter Color;-1;;2;84bcc1baa84e09b4fba5ba52924b2334;2,13,1,14,0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;334;-3680,-4352;Inherit;False;CloudHighlightColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;332;-3664,-4528;Inherit;False;CloudColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;797;-2992,-4528;Inherit;False;MoonlightColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;917;-3856,-4528;Inherit;False;Filter Color;-1;;3;84bcc1baa84e09b4fba5ba52924b2334;2,13,0,14,1;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;920;-3184,-4528;Inherit;False;Filter Color;-1;;4;84bcc1baa84e09b4fba5ba52924b2334;2,13,0,14,1;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;689;6792.185,-1317.058;Inherit;False;Global;CZY_CirrusMultiplier;CZY_CirrusMultiplier;16;2;[HideInInspector];[Header];Create;False;1;Cirrus Clouds;0;0;False;0;False;1;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;665;6202.655,-2272.49;Inherit;False;Global;CZY_CirrusMoveSpeed;CZY_CirrusMoveSpeed;17;1;[HideInInspector];Create;False;0;0;0;False;0;False;0;0.297;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;571;3588.306,-2275.23;Inherit;False;Global;CZY_ChemtrailsMoveSpeed;CZY_ChemtrailsMoveSpeed;21;1;[HideInInspector];Create;False;0;0;0;False;0;False;0;0.289;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;577;4070.836,-1363.799;Inherit;False;Global;CZY_ChemtrailsMultiplier;CZY_ChemtrailsMultiplier;19;1;[HideInInspector];Create;False;1;Chemtrails;0;0;False;0;False;1;0;0;2;0;1;FLOAT;0
...
WireConnection;797;0;920;0
WireConnection;917;1;36;0
WireConnection;920;1;796;0
WireConnection;512;0;510;0
WireConnection;510;0;511;0
WireConnection;510;1;921;0
WireConnection;921;1;524;0
